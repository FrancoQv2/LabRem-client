...
function FormText({ name, limit, showLimit = true, state, setState, helpText }) {
    ...
    <Row className='my-3'>
      ...
      >
        <Row className='my-3'>
          ...
          <Col sm={4} md={6} lg={6}>
            <Form.Control type='text' aria-describedby='text-state' value={state} onChange={handleTextChange} />
