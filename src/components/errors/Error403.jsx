        ...
        <>
            <div className="container text-center">
                ...
                <Card className="mx-auto my-5 p-3 bg-light shadow-lg text-center rounded-lg">
                    ...
                    <hr />
                    <Card.Text>
                        El error 403 o 403 Forbidden es un código de respuesta HTTP el cual indica que 
                        el servidor ha recibido y ha entendido la petición, pero rechaza enviar una respuesta.
                    </Card.Text>
                    <hr />
                    <Card.Text>
                        Para más información puedes consultar el siguiente enlace: 
                    </Card.Text>
                    <a target="_blank" href="https://developer.mozilla.org/es/docs/Web/HTTP/Status/403">
